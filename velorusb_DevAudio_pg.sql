...
CREATE TABLE "books" (
  ...
  "posted_by_user_id" INTEGER DEFAULT NULL,
  "description" text DEFAULT NULL,
...
CREATE TABLE "playback_history" (
  ...
  "user_id" INTEGER  NOT NULL,
  "book_id" INTEGER  NOT NULL,
  "playlist_item_id" INTEGER DEFAULT NULL,
...
CREATE TABLE "playlist_items" (
  ...
  "created_at" TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  "content_key_encrypted" BYTEA DEFAULT NULL,
  "content_iv" BYTEA DEFAULT NULL,
  "auth_tag" BYTEA DEFAULT NULL,
...
CREATE TABLE "subscriptions" (
  "id" SERIAL,
  "user_id" INTEGER  NOT NULL,
  "plan_type" VARCHAR(255) NOT NULL DEFAULT 'monthly' CHECK ("plan_type" IN ('test_minute','monthly','yearly','lifetime')),
  "status" VARCHAR(255) NOT NULL DEFAULT 'active' CHECK ("status" IN ('active','expired','cancelled')),
...
CREATE TABLE "subscription_history" (
  "id" SERIAL,
  "user_id" INTEGER  NOT NULL,
  "action" VARCHAR(255) NOT NULL CHECK ("action" IN ('subscribed','renewed','cancelled','expired','upgraded','downgraded')),
  "plan_type" VARCHAR(255) DEFAULT NULL CHECK ("plan_type" IN ('test_minute','monthly','yearly','lifetime')),
...
CREATE TABLE "users" (
  ...
  "status" VARCHAR(255) NOT NULL DEFAULT 'active' CHECK ("status" IN ('active','banned','inactive')),
  "created_at" TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "user_books" (
  ...
  "is_downloaded" SMALLINT DEFAULT 0,
  ...
  "current_playlist_item_id" INTEGER DEFAULT NULL
);
...
DROP TABLE IF EXISTS "user_completed_tracks" CASCADE;
...
DROP TABLE IF EXISTS "user_content_keys" CASCADE;
...
COMMENT ON COLUMN "playlist_items"."content_key_encrypted" IS 'Encrypted content key (AES-256-GCM)';
COMMENT ON COLUMN "playlist_items"."content_iv" IS 'IV used for content encryption (GCM uses 12 bytes)';
COMMENT ON COLUMN "playlist_items"."auth_tag" IS 'GCM authentication tag';
COMMENT ON COLUMN "playlist_items"."encryption_version" IS 'Encryption scheme version';
COMMENT ON COLUMN "user_content_keys"."wrapped_key" IS 'ContentKey wrapped with UserKey';
COMMENT ON COLUMN "user_content_keys"."wrap_iv" IS 'IV used for key wrapping';
COMMENT ON COLUMN "user_content_keys"."wrap_auth_tag" IS 'GCM auth tag for wrapping';
...
CREATE UNIQUE INDEX "idx_bookmarks_uq_user_bookmark" ON "bookmarks" ("user_id","book_id","chapter");
CREATE INDEX "idx_bookmarks_book_id" ON "bookmarks" ("book_id");
ALTER TABLE "books" ADD PRIMARY KEY ("id");
CREATE INDEX "idx_books_fk_books_primary_category" ON "books" ("primary_category_id");
ALTER TABLE "book_categories" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_book_categories_uq_book_category" ON "book_categories" ("book_id","category_id");
CREATE INDEX "idx_book_categories_category_id" ON "book_categories" ("category_id");
ALTER TABLE "book_ratings" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_book_ratings_unique_user_book" ON "book_ratings" ("user_id","book_id");
CREATE INDEX "idx_book_ratings_idx_book_id" ON "book_ratings" ("book_id");
CREATE INDEX "idx_book_ratings_idx_user_id" ON "book_ratings" ("user_id");
ALTER TABLE "categories" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_categories_slug" ON "categories" ("slug");
CREATE INDEX "idx_categories_parent_id" ON "categories" ("parent_id");
ALTER TABLE "encrypted_files" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_encrypted_files_encrypted_path" ON "encrypted_files" ("encrypted_path");
CREATE INDEX "idx_encrypted_files_idx_original_path" ON "encrypted_files" ("original_path");
ALTER TABLE "favorites" ADD PRIMARY KEY ("user_id","book_id");
CREATE INDEX "idx_favorites_book_id" ON "favorites" ("book_id");
ALTER TABLE "pending_users" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_pending_users_email" ON "pending_users" ("email");
ALTER TABLE "playback_history" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_playback_history_unique_user_book_track" ON "playback_history" ("user_id","book_id","playlist_item_id");
CREATE INDEX "idx_playback_history_book_id" ON "playback_history" ("book_id");
CREATE INDEX "idx_playback_history_idx_playlist_item_id" ON "playback_history" ("playlist_item_id");
ALTER TABLE "playlist_items" ADD PRIMARY KEY ("id");
CREATE INDEX "idx_playlist_items_idx_book_id" ON "playlist_items" ("book_id");
ALTER TABLE "quizzes" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_quizzes_unique_book_track_quiz" ON "quizzes" ("book_id","playlist_item_id");
CREATE INDEX "idx_quizzes_fk_quizzes_playlist_item" ON "quizzes" ("playlist_item_id");
ALTER TABLE "quiz_questions" ADD PRIMARY KEY ("id");
CREATE INDEX "idx_quiz_questions_quiz_id" ON "quiz_questions" ("quiz_id");
ALTER TABLE "server_config" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_server_config_config_key" ON "server_config" ("config_key");
ALTER TABLE "subscriptions" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_subscriptions_user_id" ON "subscriptions" ("user_id");
CREATE INDEX "idx_subscriptions_idx_user_status" ON "subscriptions" ("user_id","status");
CREATE INDEX "idx_subscriptions_idx_end_date" ON "subscriptions" ("end_date");
ALTER TABLE "subscription_history" ADD PRIMARY KEY ("id");
CREATE INDEX "idx_subscription_history_idx_user_action" ON "subscription_history" ("user_id","action_date");
ALTER TABLE "token_blacklist" ADD PRIMARY KEY ("id");
CREATE INDEX "idx_token_blacklist_idx_token" ON "token_blacklist" ("token");
CREATE INDEX "idx_token_blacklist_idx_expires" ON "token_blacklist" ("expires_at");
...
CREATE UNIQUE INDEX "idx_user_books_uq_user_book" ON "user_books" ("user_id","book_id");
CREATE INDEX "idx_user_books_book_id" ON "user_books" ("book_id");
ALTER TABLE "user_completed_tracks" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_user_completed_tracks_unique_completion" ON "user_completed_tracks" ("user_id","track_id");
CREATE INDEX "idx_user_completed_tracks_track_id" ON "user_completed_tracks" ("track_id");
ALTER TABLE "user_content_keys" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_user_content_keys_unique_user_device_media" ON "user_content_keys" ("user_id","device_id","media_id");
CREATE INDEX "idx_user_content_keys_idx_user_device" ON "user_content_keys" ("user_id","device_id");
CREATE INDEX "idx_user_content_keys_idx_media" ON "user_content_keys" ("media_id");
ALTER TABLE "user_downloads" ADD PRIMARY KEY ("user_id","book_id");
CREATE INDEX "idx_user_downloads_book_id" ON "user_downloads" ("book_id");
ALTER TABLE "user_quiz_results" ADD PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX "idx_user_sessions_unique_user" ON "user_sessions" ("user_id");
CREATE INDEX "idx_user_sessions_idx_user_id" ON "user_sessions" ("user_id");
CREATE INDEX "idx_user_sessions_idx_refresh_token" ON "user_sessions" ("refresh_token");
CREATE INDEX "idx_user_sessions_idx_expires" ON "user_sessions" ("expires_at");
CREATE INDEX "idx_user_sessions_idx_access_token" ON "user_sessions" ("access_token");
ALTER TABLE "user_track_progress" ADD PRIMARY KEY ("id");
CREATE UNIQUE INDEX "idx_user_track_progress_unique_user_track" ON "user_track_progress" ("user_id","playlist_item_id");
CREATE INDEX "idx_user_track_progress_book_id" ON "user_track_progress" ("book_id");
CREATE INDEX "idx_user_track_progress_playlist_item_id" ON "user_track_progress" ("playlist_item_id");
SELECT setval(pg_get_serial_sequence('"badges"', 'id'), 62);
SELECT setval(pg_get_serial_sequence('"books"', 'id'), 28);
SELECT setval(pg_get_serial_sequence('"book_ratings"', 'id'), 47);
SELECT setval(pg_get_serial_sequence('"categories"', 'id'), 133);
SELECT setval(pg_get_serial_sequence('"playback_history"', 'id'), 1074);
SELECT setval(pg_get_serial_sequence('"playlist_items"', 'id'), 151);
SELECT setval(pg_get_serial_sequence('"quizzes"', 'id'), 43);
SELECT setval(pg_get_serial_sequence('"quiz_questions"', 'id'), 45);
SELECT setval(pg_get_serial_sequence('"server_config"', 'id'), 2);
SELECT setval(pg_get_serial_sequence('"subscriptions"', 'id'), 33);
SELECT setval(pg_get_serial_sequence('"subscription_history"', 'id'), 503);
SELECT setval(pg_get_serial_sequence('"token_blacklist"', 'id'), 532);
SELECT setval(pg_get_serial_sequence('"users"', 'id'), 43);
SELECT setval(pg_get_serial_sequence('"user_books"', 'id'), 63);
SELECT setval(pg_get_serial_sequence('"user_completed_tracks"', 'id'), 408);
SELECT setval(pg_get_serial_sequence('"user_quiz_results"', 'id'), 62);
SELECT setval(pg_get_serial_sequence('"user_sessions"', 'id'), 311);
SELECT setval(pg_get_serial_sequence('"user_track_progress"', 'id'), 1768);
ALTER TABLE "bookmarks" ADD CONSTRAINT "bookmarks_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "bookmarks" ADD CONSTRAINT "bookmarks_ibfk_2" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "books" ADD CONSTRAINT "fk_books_primary_category" FOREIGN KEY ("primary_category_id") REFERENCES "categories" ("id") ON DELETE SET NULL;
ALTER TABLE "book_categories" ADD CONSTRAINT "book_categories_ibfk_1" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "book_categories" ADD CONSTRAINT "book_categories_ibfk_2" FOREIGN KEY ("category_id") REFERENCES "categories" ("id") ON DELETE CASCADE;
ALTER TABLE "categories" ADD CONSTRAINT "categories_ibfk_1" FOREIGN KEY ("parent_id") REFERENCES "categories" ("id") ON DELETE CASCADE;
ALTER TABLE "favorites" ADD CONSTRAINT "favorites_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "favorites" ADD CONSTRAINT "favorites_ibfk_2" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "playback_history" ADD CONSTRAINT "fk_playback_playlist_item" FOREIGN KEY ("playlist_item_id") REFERENCES "playlist_items" ("id") ON DELETE CASCADE;
ALTER TABLE "playback_history" ADD CONSTRAINT "playback_history_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "playback_history" ADD CONSTRAINT "playback_history_ibfk_2" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "quizzes" ADD CONSTRAINT "fk_quizzes_playlist_item" FOREIGN KEY ("playlist_item_id") REFERENCES "playlist_items" ("id") ON DELETE CASCADE;
ALTER TABLE "quizzes" ADD CONSTRAINT "quizzes_ibfk_1" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
...
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "subscription_history" ADD CONSTRAINT "subscription_history_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
...
ALTER TABLE "user_books" ADD CONSTRAINT "user_books_ibfk_2" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "user_completed_tracks" ADD CONSTRAINT "user_completed_tracks_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "user_completed_tracks" ADD CONSTRAINT "user_completed_tracks_ibfk_2" FOREIGN KEY ("track_id") REFERENCES "playlist_items" ("id") ON DELETE CASCADE;
ALTER TABLE "user_downloads" ADD CONSTRAINT "user_downloads_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "user_downloads" ADD CONSTRAINT "user_downloads_ibfk_2" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "user_quiz_results" ADD CONSTRAINT "user_quiz_results_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "user_quiz_results" ADD CONSTRAINT "user_quiz_results_ibfk_2" FOREIGN KEY ("quiz_id") REFERENCES "quizzes" ("id") ON DELETE CASCADE;
ALTER TABLE "user_sessions" ADD CONSTRAINT "user_sessions_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "user_track_progress" ADD CONSTRAINT "user_track_progress_ibfk_1" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
ALTER TABLE "user_track_progress" ADD CONSTRAINT "user_track_progress_ibfk_2" FOREIGN KEY ("book_id") REFERENCES "books" ("id") ON DELETE CASCADE;
ALTER TABLE "user_track_progress" ADD CONSTRAINT "user_track_progress_ibfk_3" FOREIGN KEY ("playlist_item_id") REFERENCES "playlist_items" ("id") ON DELETE CASCADE;
COMMIT;