import sys
import database1
# Inject database1 as 'database' so all other modules use it
sys.modules['database'] = database1
...
def rate_book(book_id):
    ...
    try:
        ...
        upsert_query = """
            ...
            VALUES (%s, %s, %s)
            ON CONFLICT (user_id, book_id) DO UPDATE SET stars = EXCLUDED.stars, updated_at = CURRENT_TIMESTAMP
        """
